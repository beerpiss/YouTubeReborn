...
- (id<XCDYouTubeOperation>)getVideoWithIdentifier:(NSString*)videoIdentifier
                                ...
                                completionHandler:
                                    (void (^)(XCDYouTubeVideo* _Nullable, NSError* _Nullable))completionHandler {
    if (!completionHandler)
        @throw [NSException exceptionWithName:NSInvalidArgumentException
                                       reason:@"The `completionHandler` argument must not be nil."
                                     userInfo:nil];

    XCDYouTubeVideoOperation* operation =
        [[XCDYouTubeVideoOperation alloc] initWithVideoIdentifier:videoIdentifier
...
#pragma clang diagnostic ignored "-Warc-retain-cycles"
        if (operation.video || operation.error) {
            ...
            NSAssert(operation.isCancelled,
...
- (id<XCDYouTubeOperation>)getVideoWithIdentifier:(NSString*)videoIdentifier
    ...
    return [self getVideoWithIdentifier:videoIdentifier
                                cookies:nil
                         customPatterns:nil
...
- (XCDYouTubeVideoQueryOperation*)queryVideo:(XCDYouTubeVideo*)video
                                     cookies:(NSArray<NSHTTPCookie*>*)cookies
                           completionHandler:(void (^)(NSDictionary* _Nonnull,
                                                       NSError* _Nullable,
                                                       NSDictionary<id, NSError*>* _Nonnull))completionHandler {
    return [self queryVideo:video
          streamURLsToQuery:nil
                    options:nil
                    cookies:cookies
          completionHandler:completionHandler];
}
...
- (XCDYouTubeVideoQueryOperation*)queryVideo:(XCDYouTubeVideo*)video
                           ...
                           completionHandler:(void (^)(NSDictionary* _Nullable,
                                                       NSError* _Nullable,
                                                       NSDictionary<id, NSError*>* _Nullable))completionHandler {
    if (!completionHandler)
        @throw [NSException exceptionWithName:NSInvalidArgumentException
                                       reason:@"The `completionHandler` argument must not be nil."
                                     userInfo:nil];

    XCDYouTubeVideoQueryOperation* operation = [[XCDYouTubeVideoQueryOperation alloc] initWithVideo:video
                                                                                  streamURLsToQuery:streamURLsToQuery
                                                                                            options:options
                                                                                            cookies:cookies];
    operation.completionBlock = ^{
      [[NSOperationQueue mainQueue] addOperationWithBlock:^{
...
#pragma clang diagnostic ignored "-Warc-retain-cycles"
        if (operation.streamURLs || operation.error) {
            ...
            NSAssert(operation.isCancelled,
                     @"Both `streamURLs` and `error` can not be nil if the operation was not canceled.");
        }
        operation.completionBlock = nil;
#pragma clang diagnostic pop
      }];
